...
$$\sigma^2_E = Var\left(\sum_{i=1}^{I}{e_{ri}}\right) = \sum_{i=1}^{I}{Var\left(e_{ri}\right)} = \sum_{i=1}^{I}{Var\left(\psi^2_{i}\right)}$$

Then, the reliability for sum scores becomes:

$$ \omega = \rho_{sumscore} = \frac{\sigma^2_T}{\sigma^2_E} = \frac{\left(\sum_{i=1}^{I}{\lambda_i} \right)^2 \sigma^2_F}{\left(\sum_{i=1}^{I}{\lambda_i} \right)^2 \sigma^2_F + \sum_{i=1}^{I}{Var\left(\psi^2_{i}\right)}}$$
...
$$\sigma^2_E = \left(\frac{1}{\sigma^2_F} + \sum_{i=1}^{I}\frac{\lambda^2_i}{\psi^2_i} \right)^{-1} $$
